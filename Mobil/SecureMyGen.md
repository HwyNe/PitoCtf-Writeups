...
Challenge Dosyası: 📥 Github - SecureMyGen.apk
...
✅ Hex string'ler metodlardan döner (a(), b(), c(), ...)
✅ Hex string'ler birleştirilir
✅ b(String) ile byte array'e çevrilir
✅ bb([B[B) ile AES ECB decrypt yapılır
